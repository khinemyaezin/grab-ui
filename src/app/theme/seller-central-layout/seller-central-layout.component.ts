...
@Component({
  selector: 'app-seller-central-layout',
  templateUrl: './seller-central-layout.component.html',
  styleUrls: ['./seller-central-layout.component.scss']
})
export class SellerCentralLayoutComponent implements OnDestroy {
  ...
  @HostBinding('class.grabui-content-width-fix') get contentWidthFix() {
    return (
  ...
  @HostBinding('class.grabui-sidenav-collapsed-fix') get collapsedWidthFix() {
    return (
