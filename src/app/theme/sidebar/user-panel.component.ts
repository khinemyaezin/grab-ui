...
@Component({
  ...
  template: `
    <div class="grabui-user-panel">
      <img class="grabui-user-panel-avatar" [src]="user.avatar" alt="avatar" width="64" />
      <h4 class="grabui-user-panel-name">{{ user.name }}</h4>
      <h5 class="grabui-user-panel-email">{{ user.email }}</h5>
      <div class="grabui-user-panel-icons">
        <!-- <button
          mat-icon-button
